...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("oppg 2.4 \nSaturns radius i Km : " + saturn.getRadiusInKm() +" Km, vekt i Kg : " + saturn.getMasseInKg() + " Kg");
        System.out.println("oppg 2.4 \nSolens radius i Km : " + sun.getRadiusInKm() + " Km, Vekt i Kg : " + sun.getMasseInKg() + " Kg");
        ...
        Collections.sort(Arrays.asList(solarSystem.getPlanets()));
